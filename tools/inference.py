...
# python3 tools/trainer.py --mode test --checkpoint models/second_try/epoch_58.pth --cm_path plots/cm_best --roc_path plots/roc_best

# python3 tools/inference.py --img_dir covid-chestxray-dataset --checkpoint models/second_try/epoch_58.pth --visualize_dir viz
#