...
class ChestXrayDataSet(Dataset):
    def __init__(self, image_list_file, transform=None, combine_pneumonia=False):
        ...
        self.num_not_icu = int(label_dist[0])
        self.num_in_icu = int(label_dist[1])
        self.total = self.num_not_icu +self.num_in_icu
        self.loss_weight_minus = torch.FloatTensor([self.num_not_icu, self.num_in_icu]).unsqueeze(0) / self.total
        self.loss_weight_plus = 1.0 - self.loss_weight_minus
        ...
        self.partitions = [self.num_not_icu, self.num_in_icu]
